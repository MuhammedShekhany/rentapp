...
export async function GET(req: Request) {
  try {
    ...
    // التحقق التلقائي الذكي من النوع بناءً على المعاملات المرسلة إذا لم يرسل type صراحة
    let type = searchParams.get("type");
    if (!type) {
      if (month) type = "monthly";
      else if (year) type = "yearly";
      else if (date) type = "daily";
      else type = "daily"; // الافتراضي
    }
