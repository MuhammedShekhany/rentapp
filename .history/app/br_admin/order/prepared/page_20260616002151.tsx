      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-4">
          <input
            ...
            placeholder="بحث عن رقم الطلب / اسم العميل / الهاتف..."
            className="w-full md:w-1/2 p-3 border rounded-xl focus:outline-none focus:ring"
          />
        </div>
                  ...
                  {filteredOrders.map((item) => (
                    <>
                      <tr key={item.or_id} className="hover:bg-gray-50">
                        ...
                        <td className="p-4">{item.or_total}</td>
                        <td className="p-4 text-green-600">{item.paid_total}</td>
                        <td className="p-4 text-red-600">{item.remaining}</td>
                        ...
                        <td className="p-4">
                          {item.or_preparing == 1 ? (
                            ...
                            <span className="text-orange-600 flex gap-1">
