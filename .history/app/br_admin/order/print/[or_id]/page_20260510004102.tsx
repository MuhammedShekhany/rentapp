            ...
            <div className="a5-page" dir="rtl">
                ...
                <div className="info-grid">
                    ...
                    <div className="info-block">
                        <div className="block-title">بيانات الزبون</div>
                    ...
                    <div className="info-block dates-block">
                        <div className="block-title">التواريخ</div>
                        {order.or_date && (
                            <div className="info-row">
...
.ival { font-size: 10.5px; color: #111827; font-weight: 600; }
.ival.name { font-size: 12px; font-weight: 800; }

/* SECTION TITLE */
.sec-title {
  font-size: 12px; font-weight: 800; color: #cf4343;
...
.tbl td {
  padding: 5px 10px; font-size: 10px; color: #111827;
