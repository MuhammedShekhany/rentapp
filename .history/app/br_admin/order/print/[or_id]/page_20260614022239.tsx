        ...
        <>
            ...
            <div className="toolbar no-print">
                <div className="toolbar-inner">
                    <span className="toolbar-id">وصل رقم #{order.or_no}</span>
            ...
            <div className="a5-page" dir="rtl">
                ...
                <div className="meta-bar">
                    <div className="meta-item">
                        ...
                        <span className="meta-val bold-l">{order.or_no}</span>
                    </div>
                ...
                <div className="info-grid">
                    ...
                    <div className="info-block">
                        ...
                        {order.or_cus_phone && (
                            <div className="info-row" style={{ direction: "rtl" }}>
                                <span className="ikey">الرقم  :   {formatIraqPhone(order.or_cus_phone)}</span>
                            </div>
                        )}
                        {order.or_cus_phone2 && (
                            <div className="info-row" style={{ direction: "rtl" }}>
                                <span className="ikey">الرقم :    {formatIraqPhone(order.or_cus_phone2)}</span>
                            </div>
                        )}
                    </div>
...
.meta-bar {
  ...
  padding: 7px 14px 5px; background: #ffffff;
}
...
.meta-lbl { font-size: 14px; color: #000000; font-weight: 600; letter-spacing: 0.04em; }
.meta-val { font-size: 14px; color: #111827; font-weight: 600; }
.bold-xl { font-size: 15px !important; font-weight: 800 !important; }

.vip-pill {
  background: #fef3c7; border: 1px solid #fcd34d;
  color: #0a0a0a; font-size: 9px; font-weight: 800;
  padding: 2px 10px; border-radius: 999px; letter-spacing: 0.04em;
}

/* DIVIDER */
.hr-dash {
  border: none; border-top: 1.6px dashed #d1d5db;
  margin: 0 14px;
}

.underline-dash {
  border-bottom: 1.6px dashed #999;
...
.info-grid {
  ...
  padding: 8px 14px; gap: 12px; background: #ffffff;
}
.info-block { display: flex; flex-direction: column; gap: 5px; }
.dates-block {padding-right: 12px;  padding-left: 8px;}
.block-title {
...
/* cus_INF title*/
.ikey {
  font-size: 12px; color: #0f0f0f; font-weight: 700;
...
.sec-title {
  ...
  background-color: #ec1cad; /* background color */
  border-radius: 0px;        /* optional rounded corners */
  display: inline-block;     /* keeps background around text only */
}
...
.tr-even td { background: #e2dfdf88; }
...
.tkey { font-size: 14px; color: #000000; font-weight: 600; white-space: nowrap; }
.tkey-lg { font-size: 14px !important; font-weight: 800 !important; }
.tdots {
  flex: 1; border-bottom: 1px dotted #d1d5db;
  margin: 0 4px 2px; min-width: 20px;
}
.tval { font-size: 14px; color: #111827; font-weight: 700; white-space: nowrap; }
.tval-lg { font-size: 14px !important; font-weight: 800 !important; }

/* NOTE */
.note-txt {
  padding: 4px 14px 8px;
  font-size: 12px; color: #000000; line-height: 1.7;
}

/* POLICY */
.policy { padding: 5px 14px 8px; }
.policy p { font-size: 11px; color: #000000; line-height: 1.9; }
...
.sig-lbl { font-size:12px; color: #020711; font-weight: 600; }
