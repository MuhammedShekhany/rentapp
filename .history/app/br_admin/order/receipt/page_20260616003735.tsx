      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
          ...
          <div>
            ...
            {/* ✅ SEARCH ADDED (no layout change) */}
            <input
              value={search}
              onChange={(e) => setSearch(e.target.value)}
              placeholder="بحث برقم الطلب أو اسم العميل أو الهاتف..."
              className="mt-3 w-full max-w-md px-4 py-2 rounded-lg border bg-white"
            />
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          ...
          <div className="bg-white rounded-2xl shadow p-5 border-r-4 border-green-600">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-gray-500 text-sm mb-1">الطلبات المستلمة</p>
          ...
          <div className="bg-white rounded-2xl shadow p-5 border-r-4 border-red-600">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-gray-500 text-sm mb-1">الطلبات غير المستلمة</p>
                      ...
                      <tr key={item.or_id} className="hover:bg-gray-50">
                        ...
                        <td className="p-4">
                          {item.or_receipt == 1 ? (
                            ...
                            <span className="text-red-600 font-bold flex gap-2">
                              <XCircle size={18} /> لم يتم الاستلام
                            </span>
                          )}
                        </td>
                      ...
                      <tr className="border-b bg-gray-50">
                        <td colSpan={16} className="p-3">
                          <div className="flex gap-2">
                            ...
                            <button
                              onClick={() => toggleReceipt(item.or_id, item.or_receipt)}
                              className={`px-4 py-2 rounded-lg text-white ${
                                item.or_receipt == 1 ? "bg-green-600" : "bg-red-600"
                              }`}
                            >
                              {item.or_receipt == 1 ? "تم الاستلام" : "تأكيد الاستلام"}
                            </button>
                            ...
                            <button
                              onClick={() =>
                                updateTamin(item.or_id, item.tamin)
                              }
