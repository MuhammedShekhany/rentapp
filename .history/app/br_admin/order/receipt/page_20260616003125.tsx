      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6">
          <input
            ...
            className="w-full p-3 rounded-xl border bg-white shadow-sm outline-none"
          />
        </div>
                ...
                <tbody>
                  {filteredOrders.map((item) => (
                    <tr key={item.or_id} className="hover:bg-gray-50">
                      ...
                      <td className="p-4">{item.or_date_reserve || "-"}</td>
                      <td className="p-4">{item.or_prepare_date || "-"}</td>
                      <td className="p-4">{item.user_fullname || "-"}</td>
                      <td className="p-4">{item.or_note || "-"}</td>
                      <td className="p-4">
                        {item.or_receipt == 1 ? "تم الاستلام" : "غير مستلم"}
                      </td>
                    </tr>
                  ))}
                </tbody>
