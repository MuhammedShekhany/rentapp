...
const s: Record<string, React.CSSProperties> = {
    ...
    productCard: { background: "#f9fafb", border: "1.5px solid #e5e7eb", borderRadius: 10, padding: "20px", cursor: "pointer", transition: "all 0.18s", display: "flex", flexDirection: "column" as const, gap:2 },
