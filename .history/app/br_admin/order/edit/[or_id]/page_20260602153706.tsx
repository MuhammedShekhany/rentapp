    ...
    const fetchAll = async () => {
      try {
        ...
        if (orderData.success) {
          ...
          setOrPrepareDate(o.or_prepare_date ? o.or_prepare_date : "");
          setOrDateReserve(o.or_date_reserve ? o.or_date_reserve : "");
          setReceiptDate(o.or_date_reciept ? o.or_date_reciept : "");
          console.log(o.or_date.split("T")[0].split(" ")[0]);
