...
export default function OrderReportPage() {
  ...
  // ✅ FIX HYDRATION: safe date formatting
    ...
    <div className="min-h-screen bg-gray-100 p-4 md:p-6" dir="rtl">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600 mt-1">
              المبيعات + المقبوضات + المصاريف + الرصيد
            </p>
          </div>
        ...
        <div className="bg-white p-4 rounded-2xl shadow text-center">
          ...
          <b className="text-red-600">{formatNumber(remainingSum)}</b>
        </div>
                  ...
                  <tbody>
                    {orders.map((o) => (
                      <tr key={o.or_id} className="border-b">
                        ...
                        <td className="p-3">{formatDate(o.or_date)}</td>
                        <td className="p-3">{o.or_cus_name}</td>
                        <td className="p-3">{formatNumber(o.or_total)}</td>
                        <td className="p-3">{formatNumber(o.paid_total)}</td>
                        <td className="p-3 text-red-600">{formatNumber(o.remaining)}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
