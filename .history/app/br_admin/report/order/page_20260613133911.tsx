...
export default function OrderReportPage() {
  ...
  // New state to manage the card clicks
  ...
  // =========================
  // DYNAMICALLY FILTERED ORDERS FOR THE TABLE
  // =========================
  const filteredOrders = useMemo(() => {
    if (paymentFilter === "paid") {
      // Show fully paid orders (remaining is 0)
      return orders.filter((order) => Number(order.remaining || 0) === 0);
    }
    if (paymentFilter === "remaining") {
      // Show orders that still have a remaining balance (> 0)
      return orders.filter((order) => Number(order.remaining || 0) > 0);
    }
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => {
                ...
                setPaymentFilter("all"); // Reset table filter on changing date scope
              }}
