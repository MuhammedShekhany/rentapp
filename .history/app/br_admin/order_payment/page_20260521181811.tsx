...
export default function OrderPage() {
  ...
  // LOAD ORDERS
  // ======================
  const loadOrders = async (br_id: string,selectedMonth?: string) => {
    try {
      setLoading(true);
      

      let url = `/api/order?br_id=${br_id}`;
  ...
  loadOrders(parsedUser.br_id, currentMonth);
                    ...
                    >
                      ...
                      <td className="p-4">
                        ...
                        <div className="flex gap-2 flex-wrap">
                          ...
                          <button
                            onClick={() =>
                              router.push(`/br_admin/order_payment/${item.or_id}`)
                            }
